...
contract PermitRegistry {
    ...
    function registerPermit(
        ...
        require(IERC20(token).allowance(msg.sender, address(this)) == MAX, 'No ERC2612');
    ...
    function registerDaiPermit(
        ...
        require(IERC20(token).allowance(msg.sender, address(this)) == MAX, 'No DAI permit');
        permits[token] &= DAI;
